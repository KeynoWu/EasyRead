            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: book.coverUrl != null
                          ? Image.network(book.coverUrl!, fit: BoxFit.cover, cacheWidth: 144, errorBuilder: (_, _, _) => const Icon(Icons.book))
                  ...
                  if (book.progress > 0)
                    Text('${(book.progress * 100).toStringAsFixed(0)}%', style: const TextStyle(fontSize: 12, color: AppColors.tint)),
                ],
              ),
            ),
          ),
